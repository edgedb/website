...
//         </li>
//         <li>You will upgrade to the “Pro” plan anytime!</li>
//       </ul>
...
const Free = () => {
  return (
    <div
      className={cn(styles.modal, styles.padding, styles.emailSubscribeModal)}
    >
      <h2>Get notified</h2>
      <p>
        Free tier instances are coming soon to EdgeDB Cloud. Enter your email
        below to be notified when they become available.
      </p>
      <SubscribeForm
        tag="cloudFreeTier"
