...
import {sortByName} from "@edgedb-site/shared/utils/sorting";
...
export const homepageCards = [
  {
    ...
    desc: "Install EdgeDB, create a simple schema, and write your first queries in under 5 minutes.",
    Icon: LearnRocketIcon,
  },
  {
    href: "/tutorial",
    title: "Interactive EdgeQL Tutorial",
    desc: "The quickest way to learn the key concepts of EdgeDB without installation, right in your browser.",
    Icon: LearnTutorialIcon,
  },
  {
    href: "/easy-edgedb",
    title: "Easy EdgeDB Book",
    desc: "An easy to follow book about using EdgeDB for an imaginary game based on the setting in Bram Stoker's 1897 book Dracula.",
    Icon: LearnBookIcon,
  },
  {
    href: "/docs",
    title: "Documentation",
    desc: "An in-depth look at everything there is to know about EdgeDB: data types, query language, schema and database setup, etc.",
    Icon: LearnDocsIcon,
  },
];
