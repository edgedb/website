    ...
    <MainLayout skipPageHeader={true} className={styles.page}>
      ...
      <div>
        ...
        <div className={styles.firstScroll}>
          <PageHeader />
          {/*<Announcement href="https://hackathon.edgedb.com">
            Join the EdgeDB online hackathon!
          </Announcement>*/}
          <div className={styles.splash}>
            <div className={styles.center}>
              <div className={styles.headers}>
                <h1 className={styles.highlight}>Let's face it</h1>
                <h1>SQL is not good enough</h1>
              </div>
              <p>
