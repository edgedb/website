...
import {CopyCode} from "@edgedb-site/shared/components/code/client";
            ...
            <div className={styles.content}>
              <BackgroundBlock colour="ffffff" particleColour="f1f1f1">
                <div className={styles.heroContainer}>
                  ...
                  >
                    <span className={styles.launchTextBold}>
                      Watch the keynote
                    </span>
                    <span>and read the announcement!</span>
                  </Link>
                  <WebGLModel
                    modelId="header"
                ...
                <div className={styles.intro}>
                  <p>
                    ...
                    solve hard design problems that make existing databases
                    unnecessarily onerous to use.
                  </p>
                  ...
                  <ul className={cn(styles.librariesList)}>
                    <li>
                      ...
                      <div className={styles.linksList}>
                        ...
                        <Link href="/docs/clients/js/index">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>Python</h3>
                      ...
                      <div className={styles.linksList}>
                        ...
                        <Link href="/docs/clients/python/index">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>Golang</h3>
                      ...
                      <div className={styles.linksList}>
                        ...
                        <Link href="/docs/clients/go/index">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>Deno</h3>
                    ...
                    <li>
                      ...
                      <div className={styles.linksList}>
                        ...
                        <Link href="https://docs.rs/edgedb-tokio">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>Dart</h3>
                      ...
                      <div className={styles.linksList}>
                        ...
                        <Link href="/docs/clients/dart/index">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>.NET</h3>
                      ...
                      <div className={styles.linksList}>
                        <Link href="https://github.com/edgedb/edgedb-net">
                          GitHub
                        </Link>
                        <Link href="/docs/clients/dotnet/index">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>Java</h3>
                      ...
                      <div className={styles.libUsage}>
                        <Code
                          language="xml"
                          code="com.edgedb:driver"
                          allowCopyOverlap
                        />
                      </div>
                      <div className={styles.linksList}>
                        <Link href="https://github.com/edgedb/edgedb-java">
                          GitHub
                        </Link>
                        <Link href="/docs/clients/java/index">Docs</Link>
                      </div>
                    </li>
                    <li>
                      <h3>Elixir</h3>
                      ...
                      <div className={styles.libUsage}>
                        <Code
                          language="txt"
                          code={`add {:edgedb, "~> 0.1"} to mix.exs`}
                          allowCopyOverlap
                        />
                      </div>
                      <div className={styles.linksList}>
                        <Link href="https://github.com/edgedb/edgedb-elixir">
                          GitHub
                        </Link>
                        <Link href="/docs/clients/elixir/index">Docs</Link>
                      </div>
                    </li>
                  </ul>
                </BackgroundBlock>
...
edgedb> select 2 + 2;`}
                ...
                <div className={styles.edbCloud}>
                  ...
                  <p>
                    ...
                    service, engineered to let you deploy your database
                    instantly and connect from anywhere with near-zero
                    configuration.
                  </p>
                  <div className={styles.cloudSubscribe}>
                    <a href="/cloud" className={styles.cloudSubscribeLink}>
                ...
                <div className={styles.faq}>
                  ...
                  <FaqItem title="So what are the new features?">
                    ...
                    <p>
                      ...
                      <Link href="/docs">the docs</Link> to understand EdgeDB
                      in all its glory.
                    </p>
                  </FaqItem>
