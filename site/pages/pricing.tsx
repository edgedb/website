...
const PricingCards = ({
  ...
  return (
    <>
      {isMobile ? (
        <PricingTabs nav={tiers} tabs={optionCards} />
      ) : (
            ...
            <div className={styles.content}>
              <BackgroundBlock colour="f7f7f7" particleColour="ffffff">
                ...
                <p className={styles.intro}>
                  As you know, EdgeDB is a fully open-source database that you
                  can use freely, whichever way you see fit. When it's time to
                  deploy, we recommend using EdgeDB Cloud. We work around the
                  clock to make it the best cloud database.
                </p>
              </BackgroundBlock>
