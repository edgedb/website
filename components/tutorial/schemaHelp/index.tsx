    ...
    <div className={styles.card} key="card_schema">
      ...
      <div className={styles.content}>
        ...
        <div className={styles.text}>
          ...
          <p>
            When you click on them you will see what other object types they
            are linked to. Magenta line from type A to type B means that type A
            has a link to type B.
          </p>
        </div>
      </div>
    </div>,
