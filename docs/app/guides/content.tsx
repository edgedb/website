...
export const queryingLinks = [
  { title: "select", url: "/guides/cheatsheet/select" },
  { title: "insert", url: "/guides/cheatsheet/insert" },
  { title: "update", url: "/guides/cheatsheet/update" },
  { title: "delete", url: "/guides/cheatsheet/delete" },
  { title: "via GraphQL", url: "/libraries/graphql/cheatsheet" },
];

export const schemaLinks = [
  { title: "Booleans", url: "/guides/cheatsheet/boolean" },
  { title: "Object Types", url: "/guides/cheatsheet/objects" },
  { title: "Functions", url: "/guides/cheatsheet/functions" },
  { title: "Aliases", url: "/guides/cheatsheet/aliases" },
  { title: "Annotations", url: "/guides/cheatsheet/annotations" },
  { title: "Link Properties", url: "/guides/cheatsheet/link_properties" },
];

export const adminLinks = [
  { title: "CLI", url: "/guides/cheatsheet/cli" },
  { title: "REPL", url: "/guides/cheatsheet/repl" },
  { title: "Admin", url: "/guides/cheatsheet/admin" },
];
