...
import {getLatestDocVersion} from "dataSources/docs";
...
export default function TutorialPage({path, latestDocsVersion}: PageProps) {
        ...
        <Provider store={store}>
          <TutorialTocProvider>
            <SchemaViewProvider>
              ...
              <Schema />
              <Search
                docsVersion={latestDocsVersion}
                defaultIndexId="tutorial"
              />
            </SchemaViewProvider>
          </TutorialTocProvider>
        </Provider>
...
export const getStaticProps: GetStaticProps<PageProps, PageParams> = async ({
  ...
  return {
    props: {
      ...
      latestDocsVersion: await getLatestDocVersion(),
    },
  };
};
