      ...
      <div className="globalPageWrapper">
        <div className={styles.content}>
          ...
          <div className={styles.contentBlock}>
            <p>
              EdgeQL is a spiritual successor to SQL designed with a few core
              principles in mind.
            </p>

            <p>
              <b>Compatible with modern languages.</b> A jaw-dropping amount of
              effort has been spent attempting to bridge the gap between the
              relational paradigm of SQL and high-level type systems of modern
              programming languages. EdgeDB sidesteps this problem by modeling
              data in an object-relational way.
            </p>

            <p>
              <b>Strongly typed.</b> EdgeQL is inextricably tied to EdgeDB's
              rigorous type system. The type of all expressions is statically
              inferred by EdgeDB.
            </p>

            <p>
              <b>Designed for programmers.</b> EdgeQL prioritizes syntax over
              keywords; It uses <code>{`{ curly braces }`}</code> to define
              scopes/structures and the assignment operator <code>:=</code> to
              set values. The result is a query language that looks more like
              code and less like word soup.
            </p>

            <p>
              <b>Easy deep querying.</b> EdgeQL takes advantage of the
              graph-relational nature of EdgeDB schemas. Instead of tables and
              foreign keys, EdgeDB lets you think in objects, properties, and
              links. Deep queries that traverse links can be represented
              cleanly, no JOINs required.
            </p>

            <p>
              <b>Composable.</b> Unlike SQL, EdgeQL's syntax is readily
              composable; queries can be cleanly nested to perform subqueries
              or nested mutations.
            </p>

            <h2 style={{padding: "20px 0px", textAlign: "center"}}>⋯</h2>

            <p style={{fontSize: "90%", textAlign: "center"}}>
...
an empty set when a conflict occurs.`,
          ...
          <div className={styles.featureBlock}>
            ...
            <div className={cn(styles.featureBlockContent, styles.vertical)}>
              <div className={styles.main}>
                <p>
                  EdgeQL is no toy language; it supports polymorphic queries, a
                  full slate of built-in convenience functions, JSON casting,
                  and more.
                </p>
              </div>
              <CodeExplainer
