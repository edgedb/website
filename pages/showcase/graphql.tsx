      ...
      <div className="globalPageWrapper">
        <div className={styles.content}>
          ...
          <div className={styles.contentBlock}>
            <p>
              EdgeDB includes built-in support for GraphQL. Once you activate
              the extension, your instance will expose a <code>/graphql</code>{" "}
              endpoint that can process queries and mutations via HTTP.
            </p>

            <p>
              All queries on this page assume the following schema. If you
              aren't familiar with how to model schemas in EdgeDB, check out
              the{" "}
              <Link href="/showcase/data-modeling">
                Data Modeling showcase
              </Link>
              .
            </p>

            <div className={cn(styles.exampleCode, styles.codeContent)}>
              <Code
  ...
  link nemesis -> Hero;
          ...
          <div className={styles.contentBlock}>
            ...
            <div className={cn(styles.exampleCode, styles.code)}>
              <Code code={`using extension graphql;`} language={"sdl"} />
            </div>
            <p>Then create and apply a migration to activate the extension.</p>
            <div className={cn(styles.exampleCode, styles.code)}>
              <Code
...
Applied m13mnixu... (000XX.edgeql)`}
            ...
            <ul>
              <li>
                <p>
                  ...
                  . For full details on the GraphQL-over-HTTP protocol, read
                  the <Link href="/docs/graphql/protocol">GraphQL docs</Link>.
                </p>
              </li>
              <li>
                <p>
            ...
            <p>
              ...
              <code>edgedb server status</code>. The database name is normally
              "edgedb" (the default database created in all instances) but
              could be the name of another database you've created in your
              instance.
            </p>
          </div>
          <div className={styles.sectionSpacer} />
          <div className={styles.contentBlock}>
            ...
            <p>
              ...
              <Link href="/docs/datamodel/aliases">expression alias</Link> is
              reflected as a query and three mutations: insert, update, and
              delete mutations. Filter by any <code>property</code> (including
              computed properties), deeply fetch any <code>link</code>, and
              write advanced queries with scalar-specific operators like{" "}
    ...
    "Hero": [
      ...
      { "name": "Iron Man" }
          ...
          <div className={styles.featureBlock}>
            ...
            <div className={cn(styles.contentBlock, styles.vertical)}>
              <p>
                Write advanced mutations containing scalar-specific operators
                like <code>increment</code> and <code>append</code>, create or
                update several objects in a single query, and safely use
                GraphQL variables. To compare these GraphQL queries
                side-by-side with their EdgeQL equivalents, check out{" "}
                <Link href="/vs/graphql">the comparison page</Link>.
              </p>
            </div>
