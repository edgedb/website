...
system, and migration tools.`}
        relPath="/showcase/data-modeling"
      />
      <div className="globalPageWrapper">
        <div className={styles.content}>
          ...
          <div className={styles.contentBlock}>
            <p>
              Most relational databases are inherently imperative; your schema
              is represented as a sequence of schema modification commands,
              usually fragmented across an array of migration scripts. Needless
              to say, this is not a human-friendly way to represent schema.
            </p>
            <p>
              In search of more intuitive modeling tools, developers often turn
              to ORM libraries and NoSQL options, which come with their own
              tradeoffs.
            </p>
            <p>
              EdgeDB solves this problem by introducing a first-party
              declarative schema modeling language that integrates deeply with
              EdgeDB’s query language, type system, and migration tools.
            </p>
          </div>
            ...
            <div className={cn(styles.featureBlockContent, styles.vertical)}>
              <div className={styles.main}>
                <p>
                  ...
                  consistency and safety. Every piece of data stored by EdgeDB
                  is strongly typed.
                </p>
              </div>
              <CodeExplainer
...
https://www.edgedb.com/docs/edgeql/funcops/set#operator::ISINTERSECT.`,
          ...
          <div className={styles.featureBlock}>
            ...
            <div className={cn(styles.featureBlockContent, styles.vertical)}>
              <div className={styles.main}>
                <p>
                  EdgeDB is no toy database. It aims to match or surpass SQL in
                  functionality, expressivity, consistency, and elegance.
                </p>
              </div>
              <CodeExplainer
                blocks={[
